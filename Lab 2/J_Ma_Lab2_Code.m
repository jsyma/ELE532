...
xlabel('t');ylabel('Amplitude');title('Impulse Response');
...
plot(t, h1(t));grid;
xlabel('t'); ylabel('h1(t)');title('h1(t) vs t');
plot(t, h2(t));grid;
xlabel('t'); ylabel('h2(t)');title('h2(t) vs t');
plot(t, h3(t));grid;
xlabel('t'); ylabel('h3(t)');title('h3(t) vs t');
plot(t, h4(t));grid;
xlabel('t'); ylabel('h4(t)');title('h4(t) vs t');

plot(t, h1(t));
xlabel('t');ylabel('h(t)');title('h(t) vs t');
hold on;
plot(t, h2(t));
plot(t, h3(t));
plot(t, h4(t));
